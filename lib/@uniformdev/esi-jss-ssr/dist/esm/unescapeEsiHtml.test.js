...
import { unescapeEsiHtml, defaultCharacterMap } from './unescapeEsiHtml';
it('should unescape default esi characters of esi:when open tags only', function () {
    ...
    var actual = unescapeEsiHtml(escapedHtmlData);
...
it('should unescape user-defined characters', function () {
    ...
    var characterMap = __assign(__assign({}, defaultCharacterMap), { '&#x0E;': '♫' });
    var actual = unescapeEsiHtml(escapedHtmlData, characterMap);
    expect(unescapedHtmlData).toBe(actual);
});
