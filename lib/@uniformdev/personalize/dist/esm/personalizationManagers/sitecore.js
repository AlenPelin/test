...
import { getSitecorePersonalizationRuleManager, } from '../ruleManagers/sitecore';
 ...
 * @param args
 */
export function getSitecorePersonalizationManager(args) {
    var _a;
    //
...
class SitecorePersonalizationManager {
    constructor(settings) {
        ...
        this.logger = (_b = settings === null || settings === void 0 ? void 0 : settings.logger) !== null && _b !== void 0 ? _b : getNullLogger();
