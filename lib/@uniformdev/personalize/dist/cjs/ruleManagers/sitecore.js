...
exports.getSitecorePersonalizationRuleManager = void 0;
 ...
 * @param args
 */
function getSitecorePersonalizationRuleManager(args) {
    const { definitions, item, logger = common_1.getNullLogger() } = args;
    if (!definitions) {
        return index_1.getDisabledPersonalizationRuleManager();
    }
    if (!item) {
        return index_1.getDisabledPersonalizationRuleManager();
    }
  ...
  */
    ...
    function runRuleActions(rule, context) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const dsBefore = common_1.tryFormatGuid((_b = (_a = context.dataSource) !== null && _a !== void 0 ? _a : context.defaultDataSource) !== null && _b !== void 0 ? _b : item === null || item === void 0 ? void 0 : item.id, 'D');
            const dsAfter = common_1.tryFormatGuid((_d = (_c = rule.data) !== null && _c !== void 0 ? _c : context.defaultDataSource) !== null && _d !== void 0 ? _d : item === null || item === void 0 ? void 0 : item.id, 'D');
...
exports.getSitecorePersonalizationRuleManager = getSitecorePersonalizationRuleManager;
