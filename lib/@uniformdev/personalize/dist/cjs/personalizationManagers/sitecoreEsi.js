...
exports.getSitecoreEsiPersonalizationManager = void 0;
 ...
 * @param args
 */
function getSitecoreEsiPersonalizationManager(args) {
    var _a, _b, _c;
...
exports.getSitecoreEsiPersonalizationManager = getSitecoreEsiPersonalizationManager;
...
class SitecoreEsiPersonalizationManager {
    constructor(settings) {
        var _a, _b, _c;
        this.logger = common_1.getNullLogger();
        this.disabled = (_a = settings.disabled) !== null && _a !== void 0 ? _a : false;
        this.logger = (_b = settings.logger) !== null && _b !== void 0 ? _b : common_1.getNullLogger();
...
function evaluatePersonalization({ activity, data, logger, page, personalizationContext, }) {
    var _a, _b, _c, _d;
    const changes = {};
    const dsBefore = common_1.tryFormatGuid((_b = (_a = personalizationContext.dataSource) !== null && _a !== void 0 ? _a : personalizationContext.defaultDataSource) !== null && _b !== void 0 ? _b : page === null || page === void 0 ? void 0 : page.id, 'D');
    ...
    const dsAfter = common_1.tryFormatGuid((_d = (_c = data === null || data === void 0 ? void 0 : data.dataSource) !== null && _c !== void 0 ? _c : personalizationContext.defaultDataSource) !== null && _d !== void 0 ? _d : page === null || page === void 0 ? void 0 : page.id, 'D');
