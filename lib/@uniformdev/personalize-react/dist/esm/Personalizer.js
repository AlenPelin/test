...
import { flattenArray, getNullLogger } from '@uniformdev/common';
...
export function getPersonalizer(args) {
    ...
    const Personalizer = (props) => {
        ...
        const logger = (_a = pContext === null || pContext === void 0 ? void 0 : pContext.logger) !== null && _a !== void 0 ? _a : getNullLogger();
        ...
        const tracker = (_b = tContext === null || tContext === void 0 ? void 0 : tContext.tracker) !== null && _b !== void 0 ? _b : getNullTracker();
        const visitorId = tContext.visitorId;
        //
        //state variables
        const [personalizedProps, setPersonalizedProps] = useState(rendering);
        //
        //route-change effect
        useEffect(() => {
        ...
        return React.createElement(PersonalizedComponent, Object.assign({}, personalizedProps));
    };
    return Personalizer;
}
