 ...
 * @param args
 */
export function getDispatchersFromTrackingConfig(trackingConfig, args) {
    var logger = args.logger, loggerPrefix = args.loggerPrefix;
    var dispatchers = [];
    ...
    keys.forEach(function (key) {
        ...
        switch (key) {
            case "ga":
                ...
                var gaDispatchers = (_b = getDispatchersForGaDestinations(destinations, args)) !== null && _b !== void 0 ? _b : [];
                ...
                return;
            case "oracleDmp":
                var oracleDmpDispatchers = (_c = getDispatchersForOracleDmpDestinations(destinations, args)) !== null && _c !== void 0 ? _c : [];
                ...
                return;
            case "xdb":
                var xdbDispatchers = (_d = getDispatchersForXdbDestinations(destinations, args)) !== null && _d !== void 0 ? _d : [];
