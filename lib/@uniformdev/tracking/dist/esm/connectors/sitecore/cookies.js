import { getVisitActivities } from './activities';
/**
 * Gets the values for a property from the visitor
 * in a format that can be set as a cookie value.
 * @param visitor
 */
export function getCookieValueFromVisitor(type, visitor) {
    var _a, _b;
 ...
 * @param visit
 */
export function getCookieValueFromVisit(type, visit) {
    var _a, _b;
    if (visit === null || visit === void 0 ? void 0 : visit.data) {
        if (type == 'goals') {
            var goals = getVisitActivities('goal', visit);
