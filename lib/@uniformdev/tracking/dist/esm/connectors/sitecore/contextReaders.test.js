import { getSitecoreContextReader } from './contextReaders';
...
describe('JSS context reader', function () {
    it('should return a jss reader when the source is jss', function () {
        var reader = getSitecoreContextReader('jss');
