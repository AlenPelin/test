...
import { getSitecoreContextReader, CONTEXT_SOURCE_SITECORE } from './contextReaders';
import { getDifferenceAsTimeIncrements, doDecay, getDefaultDecaySettings } from '../../decay';
import { getDefaultTracker } from '../../trackers';
export var SitecoreCookieNames;
...
})(SitecoreCookieNames || (SitecoreCookieNames = {}));
/**
...
function getDefaultContextReadersForSitecoreTracker(args, logger) {
    var _a;
    var reader = getSitecoreContextReader((_a = args.type) !== null && _a !== void 0 ? _a : 'default', logger);
    var readers = new Map();
 ...
 * @param logger
 */
export function getSitecoreTracker(args, logger) {
    if (!logger) {
    ...
    args.extensions = {
        onNewVisitCreated: function (date, visitor, oldVisit, newVisit, logger) {
            ...
            if (oldVisit) {
                var settings = (_b = args.decay) !== null && _b !== void 0 ? _b : getDefaultDecaySettings();
...
function getProfileDataWithDecay(oldData, differenceForDecay, settings, logger) {
    ...
    Object.keys(oldData).forEach(function (profileId) {
        ...
        Object.keys(profile.keys).forEach(function (profileKeyId) {
            ...
            newProfileKey.value = doDecay((_a = newProfileKey.value) !== null && _a !== void 0 ? _a : 0, differenceForDecay, settings, logger);
        ...
        var decayedUpdateCount = doDecay((_a = profile.updateCount) !== null && _a !== void 0 ? _a : 0, differenceForDecay, settings, logger);
...
function applyProfilesFromOldVisit(settings, date, visitor, oldVisit, newVisit, logger) {
    ...
    var differenceForDecay = getDifferenceAsTimeIncrements(oldVisit.updated, newVisit.updated, settings, logger);
