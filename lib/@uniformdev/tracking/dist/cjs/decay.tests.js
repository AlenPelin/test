...
describe('Simple rate decay', function () {
    ...
    it('Simple decay with no rounding needed.', function () {
        ...
        var difference = 2;
        var actualValue = decay_1.doDecay(originalValue, difference, settings, nullLogger);
    ...
    it('Simple decay with rounding closest.', function () {
        ...
        var actualValueUp = decay_1.doDecay(originalValue, difference, settingsUp, nullLogger);
        expect(actualValueUp).toEqual(expectedValueUp);
        var actualValueDown = decay_1.doDecay(originalValue, difference, settingsDown, nullLogger);
