...
function EsiOtherwise(props) {
    var placeholder = react_1.default.createElement(sitecore_jss_react_1.Placeholder, { name: "esi-otherwise", rendering: props.rendering, componentFactory: props.componentFactory });
    ...
    return react_1.default.createElement('esi:otherwise', {}, placeholder);
}
exports.default = EsiOtherwise;
