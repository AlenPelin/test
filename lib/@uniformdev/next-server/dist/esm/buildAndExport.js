            ...
            switch (_c.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, exec(command1, {
                            env: __assign(__assign({}, config.env), { EXPORT_OUT_DIR: outputDir, UNIFORM_OPTIONS_PREVIEW: '0', UNIFORM_OPTIONS_DEBUG: '0', UNIFORM_API_URL: apiUrl, UNIFORM_API_SITENAME: sitename }),
                            cwd: clientRepoDir,
                            maxBuffer: 20 * 1024 * 1024,
                        })];
                case 4:
