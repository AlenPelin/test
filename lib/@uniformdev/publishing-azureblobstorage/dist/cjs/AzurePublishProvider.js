...
var AzurePublishProvider = /** @class */ (function (_super) {
    ...
    function AzurePublishProvider(_a) {
        ...
        if (azcopyPath) {
            ...
            if (azcopyPath) {
                if (!fs_1.existsSync(azcopyPath)) {
                    throw new Error('The UNIFORM_PUBLISH_PROVIDER_AZUREBLOB_AZCOPY_PATH env variable points to file that does not exist: ' + azcopyPath);
                }
            }
            else {
            ...
            return __generator(this, function (_a) {
                ...
                policy = {
                    AccessPolicy: {
                        ...
                        // @ts-ignore 
                        Permissions: azure_storage_1.default.BlobUtilities.SharedAccessPermissions.READ + azure_storage_1.default.BlobUtilities.SharedAccessPermissions.ADD + azure_storage_1.default.BlobUtilities.SharedAccessPermissions.CREATE + azure_storage_1.default.BlobUtilities.SharedAccessPermissions.WRITE + azure_storage_1.default.BlobUtilities.SharedAccessPermissions.DELETE + azure_storage_1.default.BlobUtilities.SharedAccessPermissions.LIST,
                        Start: new Date(0),
