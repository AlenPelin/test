...
import { getNullLogger, getSubscriptionManager, initializeGlobalObject, appendArray, appendObject } from '@uniformdev/common';
import { UniformContext } from '@uniformdev/react';
import { TrackerContext } from './TrackerContext';
import { useScripts } from './useScripts';
import { QUEUE_ENTRY_TYPE_TRACKER } from '@uniformdev/tracking';
import { CONTEXT_SOURCE_SITECORE } from '@uniformdev/tracking';
import { UniformCookieNames, getTrackerCookieTypes, addSubscriptionsForTrackerCookies } from '@uniformdev/tracking';
...
import { getDispatchersFromTrackingConfig } from '@uniformdev/tracking';
import { getDefaultDecaySettings } from '@uniformdev/tracking';
import { getSitecoreTracker } from '@uniformdev/tracking';
...
function getTrackerScripts(trackingConfig, props) {
    var _a;
    const scripts = {};
    appendObject((_a = trackingConfig === null || trackingConfig === void 0 ? void 0 : trackingConfig.settings) === null || _a === void 0 ? void 0 : _a.scripts, scripts);
    appendObject(props === null || props === void 0 ? void 0 : props.scripts, scripts);
    if (!scripts['optimize']) {
...
export function useSitecoreTracker(sitecoreContext, props) {
    var _a;
    const logger = (_a = props === null || props === void 0 ? void 0 : props.logger) !== null && _a !== void 0 ? _a : getNullLogger();
    ...
    useEffect(() => {
        ...
        const trackerSubs = getSubscriptionManager();
        ...
        //
        //
        const cookieTypes = getTrackerCookieTypes(trackingConfig);
        appendArray(props === null || props === void 0 ? void 0 : props.cookies, cookieTypes);
        //
        //
        ...
        if (!uniformContext.subscriptions) {
            uniformContext.subscriptions = getSubscriptionManager();
        }
        ...
        //
        const args = {
            decay: (_a = props === null || props === void 0 ? void 0 : props.decay) !== null && _a !== void 0 ? _a : getDefaultDecaySettings(),
            dispatchers,
            logger,
        ...
        if (queue) {
            ...
            while (queue.count(QUEUE_ENTRY_TYPE_TRACKER) > 0) {
                const entry = queue.get(QUEUE_ENTRY_TYPE_TRACKER);
                handleEntry(entry);
            }
            //
            //Subscribe to the global queue.
            const unsubscribe = queue.subscribe(QUEUE_ENTRY_TYPE_TRACKER, e => {
                const entry = e.entry;
                handleEntry(entry);
            });
            if (unsubscribe) {
