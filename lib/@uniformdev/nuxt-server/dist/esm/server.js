...
import { createUniformServer, startUniformServer, parseUniformServerConfig } from '@uniformdev/common-server';
import { NuxtBuildAndExportEngine } from '.';
export function server(_a) {
    ...
    var prepare = function () { return (dev ? new Builder(app).build() : Promise.resolve()); };
    ...
    prepare().then(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    buildAndExportEngine = new NuxtBuildAndExportEngine();
