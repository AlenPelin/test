...
exports.EnhancedRouterLink = {
    ...
    render: function (createElement) {
        ...
        var value = common_1.trim(resolvedUrl, '/');
    ...
    head: function () {
        ...
        var env = common_1.parseUniformConfig(Object.assign({}, process.env, this.$nuxtEnv, this.runtimeConfig));
        if (this.enableLinkPrefetch || (env && env.UNIFORM_OPTIONS_PREFETCH_LINKS)) {
            var resolvedUrl = this.resolveUrl();
            var prefetchPageUrl = common_client_1.getPageUrl(resolvedUrl, 'page', env);
