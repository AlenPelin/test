...
export function createRendering(r, _placeholderKey, index, componentMap, props, createElement) {
    ...
    if (!componentMap || typeof componentMap !== 'function') {
        throwException('Component map is not defined');
    }
    var tagName = r.componentName || throwException('No componentName');
    var component = componentMap(tagName) || throwException('Cannot find component: ' + tagName);
    var key = r.id;
    var newProps = {
        index: index,
