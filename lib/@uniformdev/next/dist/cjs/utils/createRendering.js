...
function createRendering(r, placeholderKey, index, components, props, logger) {
    ...
    var ds = r.datasource || '00000000000000000000000000000000';
    {
        ...
        if (htmlMap && componentName !== __1.GLOBAL_LOADER && !componentName.endsWith(__1.COMPONENT_LOADER_SUFFIX)) {
            ...
            var html = htmlsPerDatasources[common_1.tryParseGuid(ds) + '|' + r.settings.Parameters];
            if (html !== null) {
    ...
    var component = components[componentName] || common_1.throwException("Cannot find component " + componentName);
    var newProps = {
        key: r.id,
        index: index,
